...
HD_PWD='C:/Coding/FPGA_REAL/FPGA/Scrolling_LEDs/Scrolling_LEDs.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log scrolling_leds.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source scrolling_leds.tcl
