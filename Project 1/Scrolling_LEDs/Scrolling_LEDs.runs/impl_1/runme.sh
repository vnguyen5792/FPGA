...
HD_PWD='C:/Coding/FPGA_REAL/FPGA/Scrolling_LEDs/Scrolling_LEDs.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log scrolling_leds.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source scrolling_leds.tcl -notrace
