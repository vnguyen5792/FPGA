...
HD_PWD='C:/Coding/FPGA_REAL/FPGA/Proect 2 Retry/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log psadb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source psadb.tcl
