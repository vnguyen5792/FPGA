...
HD_PWD='C:/Coding/FPGA_REAL/FPGA/Proect 2 Retry/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log psadb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source psadb.tcl -notrace
