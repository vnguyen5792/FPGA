...
HD_PWD='C:/Users/vieta/OneDrive/Desktop/School Stuff/Fall 2025/FPGA/Project 2/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log slow_clock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source slow_clock.tcl -notrace
